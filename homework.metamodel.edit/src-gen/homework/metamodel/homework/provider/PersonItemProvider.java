...
/**
 * This is the item provider adapter for a {@link homework.metamodel.homework.Person} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Person_student_feature",
								"_UI_Person_type"),
						HomeworkPackage.Literals.PERSON__STUDENT, true, false, true, null, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Person_teacher_feature",
								"_UI_Person_type"),
						HomeworkPackage.Literals.PERSON__TEACHER, true, false, true, null, null, null));
	}
