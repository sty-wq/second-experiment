...
/**
 * This is the item provider adapter for a {@link homework.metamodel.homework.Course} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CourseItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						HomeworkPackage.Literals.COURSE__NAME, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(HomeworkPackage.Literals.COURSE__HOMEWORK);
			childrenFeatures.add(HomeworkPackage.Literals.COURSE__PERSON);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(HomeworkPackage.Literals.COURSE__HOMEWORK,
				HomeworkFactory.eINSTANCE.createHomework()));

		newChildDescriptors.add(createChildParameter(HomeworkPackage.Literals.COURSE__PERSON,
				HomeworkFactory.eINSTANCE.createTeacher()));

		newChildDescriptors.add(createChildParameter(HomeworkPackage.Literals.COURSE__PERSON,
				HomeworkFactory.eINSTANCE.createStudent()));
	}
